...
require (
	...
	git.sr.ht/~sircmpwn/sourcehut-ssh v0.0.0-20251014065653-ff37129c25fe
...
replace github.com/go-git/go-git/v5 => git.sr.ht/~sircmpwn/go-git/v5 v5.0.0-20251014095328-ebe057883787
